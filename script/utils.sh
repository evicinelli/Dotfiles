...
declare -a commands=(
    ...
    "chromium --new-window https://sites.google.com/a/vallelavino.it/area-soci/calendario-turni-zola-61 https://sites.google.com/a/vallelavino.it/area-soci/inserimento-turni https://sites.google.com/a/vallelavino.it/area-soci/calendari-turni/emanuele-vicinelli && i3 [class="Chromium"] focus #gvs #zola61 #ambulanza #turno"
    "redshift-gtk -x #reset #day"
    "redshift-gtk -O 1000 #red #night"
    "chromium --incognito #incognito"
