...
#    #\b is  needed for [I|V|N] which is printed at the beginning of the prompt, due to the  fish_vi_key_bindings being activated
...
#
    echo -e "\b\b\b\b\b $directory_color$cwd$error_color:$normal_color "
end
