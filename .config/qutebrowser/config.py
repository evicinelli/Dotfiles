...
config.editor.command = ['gvim', '{file}']
config.fonts.default_family = 'Sans Serif'
config.fonts.default_size = "12pt"
config.fonts.web.family.fixed = 'Monospace'
config.fonts.web.family.sans_serif = 'Sans Serif'
config.fonts.web.family.serif = 'Serif'
config.fonts.web.family.standard = 'Sans Serif'
config.load_autoconfig()
config.url.default_page = 'https://ecosia.com/'
config.url.start_pages = 'https://ecosia.com'
